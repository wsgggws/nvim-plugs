...
vim.keymap.set("n", "<leader>th", "<cmd>ToggleTerm direction=horizontal size=13<cr>", { desc = "ToggleTerm bottom" })
vim.keymap.set("n", "<leader>tv", "<cmd>ToggleTerm direction=vertical size=58<cr>", { desc = "ToggleTerm right" })
